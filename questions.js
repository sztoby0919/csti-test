...
const personalityTypes = {
  ...
  "CFLD": {
    ...
    similarPlayer: "broky 的反面— 你比他还敢干拉，但没他那枪法",
  ...
  "CFBM": {
    ...
    similarPlayer: "NiKo — 个人能力拉满，但总是一个人扛着走",
  ...
  "CABD": {
    ...
    similarPlayer: "cadiaN — 指挥很准，但自己先倒了",
  ...
  "SFLM": {
    ...
    similarPlayer: "blameF — 虽然白给，但气势不能输",
  ...
  "SFLD": {
    ...
    similarPlayer: "Magisk — 看着在混，其实也能C",
  ...
  "SFBM": {
    ...
    similarPlayer: "Twistzz — 带队冲，然后一起倒",
  ...
  "SFBD": {
    ...
    similarPlayer: "s1mple — 天赋拉满，但谁的话都不听",
  ...
  "SALM": {
    ...
    similarPlayer: "karrigan — 战术大师，但队友总不听话",
  ...
  "SABM": {
    ...
    similarPlayer: "chopper — 气氛组组长，谁都喜欢",
